public class ContaBancaria {
  ...
  public boolean isChequeEspecialAtivado(){ //Verificar se está ativo
  ...
  public boolean sacarDinheiro(double valor){ //Sacar
    ...
    if(isChequeEspecial == true && this.saldo<0){
      taxaCheque();
    }
  }
  return true;
  ...
  public void taxaCheque(){ //Função para calculcar Taxa
    if(this.isChequeEspecial && this.valorCheque>0){
